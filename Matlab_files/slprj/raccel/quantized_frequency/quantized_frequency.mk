...
MODEL                  = quantized_frequency
MODULES                = quantized_frequency_capi.c quantized_frequency_data.c quantized_frequency_tgtconn.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c 
MAKEFILE               = quantized_frequency.mk
MATLAB_ROOT            = /Applications/MATLAB_R2015b.app
ALT_MATLAB_ROOT        = /Applications/MATLAB_R2015b.app
MATLAB_ROOTQ           = \"/Applications/MATLAB_R2015b.app\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /Users/Pablo/Documents/Universidad/governor-tfg/Matlab_files
S_FUNCTIONS            = rtiostream_utils.c
S_FUNCTIONS_LIB        = $(MATLAB_ROOT)/bin/maci64/libmwcoder_target_services.dylib $(MATLAB_ROOT)/bin/maci64/libmwcoder_ToAsyncQueueTgtAppSvc.dylib $(MATLAB_ROOT)/bin/maci64/libmwcoder_ParamTuningTgtAppSvc.dylib
COMPUTER               = MACI64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/Applications/MATLAB_R2015b.app" EXT_MODE=1 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
MODELLIB                  = quantized_frequencylib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/raccel/quantized_frequency \
	-I$(START_DIR) \
