...
#ifndef RTW_HEADER_quantized_frequency_acc_private_h_
#define RTW_HEADER_quantized_frequency_acc_private_h_
#include "rtwtypes.h"
...
; real_T quantized_frequency_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
